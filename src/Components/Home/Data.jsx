...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Amirhossein Mirzaee
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className="home__discription">I'm Creative developer base in Tehran, and i'm very passionate and dedicated to my work.</p>
